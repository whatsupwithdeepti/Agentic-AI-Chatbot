    ...
    def load_streamlit_ui(self):
        ...
        with st.sidebar:
            ...
            if self.user_controls["selected_usecase"] == "Chatbot with Tool" or self.user_controls["selected_usecase"] == "AI News":
                os.environ["TAVILY_API_KEY"] = st.session_state["TAVILY_API_KEY"]=st.text_input("TAVILY_API_KEY",type="password")
            ...
            if self.user_controls["selected_usecase"] == "AI News":
                ...
                with st.sidebar:
                    time_frame = st.selectbox("🗓️ Select Time Frame", ["Daily", "Weekly", "Monthly"], index=0)
